...
def atkspm(screen):
    ...
    effects = [
        Print(screen,
              ColourImageFile(screen, "dinhtu.gif", screen.height,
...
def banner():
	autoketik ( f"""
 \x1b[38;2;0;191;255m          Admin:NguyenDinhTu
 \x1b[38;2;0;191;255m   - - - - - - - - - - - - - - - - - - -
 \x1b[38;2;0;191;255m  Mua Tool Liên Hệ Telegram:@m3nu_hax
 \x1b[38;2;0;191;255m       ██████  ███▄ ▄███▓  ██████ 
 \x1b[38;2;0;191;255m     ▒██    ▒ ▓██▒▀█▀ ██▒▒██    ▒ 
 \x1b[38;2;0;191;255m     ░ ▓██▄   ▓██    ▓██░░ ▓██▄   
 \x1b[38;2;0;191;255m       ▒   ██▒▒██    ▒██   ▒   ██▒
...
banner()
phone = input("@Nguyen Dinh Tu")
phone = input("\x1b[38;2;255;234;0m╚══>Phone Number : \x1b[38;2;255;255;255m")
if phone == "0929626616" or phone == "929626616":
	exit("Khong duoc spam so admin :)))")
